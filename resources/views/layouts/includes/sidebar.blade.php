    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect has-arrow waves-dark sidebar-link" href="charts.html" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">G&eacute;rer utilisateurs</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect has-arrow waves-dark sidebar-link" href="charts.html" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">G&eacute;rer fournisseurs</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect has-arrow waves-dark sidebar-link" aria-expanded="false"><i class="mdi mdi-table-large"></i><span class="hide-menu">G&eacute;rer les &eacute;tag&egrave;res</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{url('/stock/ajouter_etagere')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Ajouter un nouveau &eacute;tag&egrave;re </span></a></li>
                        @endif
                        @if (auth()->guard('utilisateur')->user()->can('lister etagere'))
                        <li class="sidebar-item"><a href="{{url('/stock/liste_etagere')}}" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Liste des &eacute;tag&egrave;res</span></a></li>
                        @endif
                    </ul>
                </li>
                @endif
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect has-arrow waves-dark sidebar-link" aria-expanded="false"><i class="mdi mdi-arrow-up-drop-circle-outline"></i><span class="hide-menu">Consommations</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"><a href="{{url('/stock/consommer')}}" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Enregistrer une consommation </span></a></li>
                        @endif
                        @if (auth()->guard('utilisateur')->user()->can('voir historique consommation'))
                        <li class="sidebar-item"><a href="{{url('/stock/historique_consommation')}}" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Historique consommation</span></a></li>
                        @endif
                    </ul>
                </li>
                @endif
