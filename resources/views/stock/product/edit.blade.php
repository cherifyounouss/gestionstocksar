            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/stock/liste_produit')}}">Liste des produits</a></li>
...
@section('content')
<div class="card">
        <form class="form-horizontal" method="POST" action="{{url('/stock/modifier_produit', $produit->id)}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nom_produit" value="{{ old('nom_produit',$produit->nom_produit)}}" name="nom_produit" placeholder="Entrer le nom du produit" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="non_solvant" value="0" name="solvant" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="select2 form-control custom-select" name="criticite" style="width: 100%; height:36px;" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-9">
                        <input type="text" class="form-control" id="datepicker-autoclose" name="date_peremption" value="{{ old('date_peremption',$produit->date_peremption)}}" placeholder="jj/mm/aaaa" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" min="0" step="0.01" id="qte_stock" value="{{ old('qte_stock', $produit->qte_stock)}}" name="qte_stock" placeholder="0000.00" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="qte_min" class="col-sm-3 text-right control-label col-form-label">Quantit&eacute; minimale dalerte</label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" min="0" step="0.01" id="qte_min" value="{{ old('qte_min', $produit->qte_min)}}" name="qte_min" placeholder="0000.00" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 text-right control-label col-form-label">Unit&eacute;</label>
                    <div class="col-sm-9">
                        <select class="form-control custom-select" id="select_unite" name="unite" style="width: 95%; height:36px;">
                            <option>Select</option>
                        </select>
                ...
                <div class="form-group row">
                    <label class="col-sm-3 text-right control-label col-form-label">&Eacute;tag&egrave;re</label>
                    <div class="col-sm-9">
                        <select class="select2 form-control custom-select" name="etagere" id="etagere" style="width: 100%; height:36px;" required>
                            <option>Select</option>
                            @foreach($etageres as $etagere)
                            <option value="{{ $etagere->libelle}}" data-casier="{{ $etagere->nbCasiers}}">{{ $etagere->libelle}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="num_casier" class="col-sm-3 text-right control-label col-form-label">Num&eacute;ro de casier</label>
                    <div class="col-sm-9">
                        <input type="number" min="1" class="form-control" id="num_casier" value="{{ old('num_casier', $produit->casier)}}" name="num_casier" placeholder="Exemple: 1" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="fds" required name="fds">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-9">
                        <input type="text" class="form-control" id="date_exp_fds" name="date_exp_fds" placeholder="jj/mm/aaaa" value="{{ old('date_exp_fds',$produit->date_exp_fds)}}">
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
...
<script>
    ...
    $("#etagere").change(function(){
        $("#num_casier").attr('max',$("#etagere option:selected").attr('data-casier'));
    })
</script>
