...
@section('content')
<div class="card">
        <form class="form-horizontal" method="POST" action="{{url('/stock/ajouter_produit')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" min="1" class="form-control" id="num_casier" value="{{ old('num_casier')}}" name="num_casier" placeholder="Exemple: 1" required>
                    </div>
                </div>
                <div class="form-group row">
