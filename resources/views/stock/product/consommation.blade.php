...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Consommation</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">Accueil</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Enregistrer une conommation</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="card">
        ...
        @endif
        <form class="form-horizontal" method="POST" action="{{url('/stock/consommer')}}">
            {{csrf_field()}}
            <div class="card-body">
                @if ($errors->any())
                ...
                @endif            
                <h4 class="card-title">Enregistrer une consommation</h4>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="select2 form-control custom-select" name="produit" id="produit" style="width: 100%; height:36px;" required>
                            ...
                            <option value="{{ $produit->id}}" data-stock="{{ $produit->qte_stock}}">{{ $produit->nom_produit}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>                           
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-9">
                        <input type="text" class="form-control" id="date_consommation" name="date_consommation" value="{{ old('date_consommation')}}" placeholder="jj/mm/aaaa">
...
<script>
    ...
    $("#produit").change(function(){
        //Le maximum du champ total est egale a la quantité disponible en stock
        $("#total").attr('max', $("#produit option:selected").attr('data-stock'))
    })
</script>    
@endsection