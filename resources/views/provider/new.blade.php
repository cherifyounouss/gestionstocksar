...
<div class="card">
        <form class="form-horizontal" method="POST" action="{{url('/ajouter_fournisseur')}}">
            ...
            <div class="card-body">
                ...
                @endif            
                <h4 class="card-title">Cr&eacute;er un fournisseur</h4>
                <div class="form-group row">
                    <label for="nom_fournisseur" class="col-sm-3 text-right control-label col-form-label">Nom fournisseur</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nom_fournisseur" value="{{ old('nom_fournisseur')}}" name="nom_fournisseur" placeholder="Entrer le nom du fournisseur">
                    </div>
                </div>
                <div class="form-group row">
                        <label for="adresse" class="col-sm-3 text-right control-label col-form-label">Adresse</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{ old('adresse') }}" id="adresse" name="adresse" placeholder="Entrer l'adresse du fournissseur">
                        </div>
                </div>
                <div class="form-group row">
                        <label for="num_tel" class="col-sm-3 text-right control-label col-form-label">Num&eacute;ro de t&eacute;l&eacute;phone</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="num_tel" value="{{old('num_tel')}}" name="num_tel" placeholder="Entrer le num&eacute;ro de t&eacute;l&eacute;phone du fournisseur">
                        </div>
                </div>
                </div>         
            </div>
