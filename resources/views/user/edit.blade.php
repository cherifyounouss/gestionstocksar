            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/liste_utilisateur')}}">Liste des utilisateurs</a></li>
...
@section('content')
<div class="card">
        <form class="form-horizontal" method="POST" action="{{url('/modifier_utilisateur', $utilisateur->id)}}">
            {{csrf_field()}}
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="prenom" value="{{ old('prenom', $utilisateur->prenom)}}" name="prenom" placeholder="Entrer le pr&eacute;nom de l'utilisateur" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nom" class="col-sm-3 text-right control-label col-form-label">Nom</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="nom" value="{{ old('nom', $utilisateur->nom)}}" name="nom" placeholder="Entrer le nom de l'utilisateur" required>
                    </div>
                </div>                
                <div class="form-group row">
                        <label for="email" class="col-sm-3 text-right control-label col-form-label">Email</label>
                        <div class="col-sm-9">
                            <input type="email" class="form-control" value="{{ old('email', $utilisateur->email) }}" id="email" name="email" placeholder="Entrer l'email de l'utilisateur" required>
                        </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="password" name="password" placeholder="Entrer le mot de passe de l'utilisateur" required>
                        </div>
                </div>
                <div class="form-group row">
